...
public class Login1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try 
        {
            ...
            rs=stmt.executeQuery("SELECT * FROM  logandreg");
            ...
            else 
            {
                if(u.isEmpty()&& p.isEmpty())
                    JOptionPane.showMessageDialog(this,"No Username and Password Input!!");
                /*else if (p.isEmpty())
                    JOptionPane.showMessageDialog(this,"No Password Input!!");
                else if (u.isEmpty())
                    JOptionPane.showMessageDialog(this,"No Username Input!!");*/
                else
                {
                    do 
                    {
                        if(u.equals(rs.getString(4))) 
                            i=1;
                        else 
                            continue;
                        if (i == 1 && p.equals(rs.getString(5)))
                        {
                            Home1 h = new Home1();
                            h.setVisible(true);
                            dispose();
